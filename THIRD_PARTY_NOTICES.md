...
This project uses the MCP Python SDK, PyObjC, PyCryptodome, Zstandard, and
the optional Frida Python bindings as external dependencies. Please review
their respective licenses in the installed environment before redistribution.
